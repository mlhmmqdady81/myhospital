...
<form style="text-align:center;" action="em_login.php" method="post">
<?php
	...
	{
			if ($result1 = $mysqli->query("SELECT ID,password FROM employee WHERE Name='$_POST[pname]' ORDER BY ID"))
			{
				if ($result1->num_rows > 0)
				{
					while ($row = $result1->fetch_object())
					{
						...
						{
							$_SESSION["EID"] = $row->ID;
							header("Location: http://localhost/hospital001/ListReservation_em.php");
						}
						else
							echo "Wrong Data!";
					}
